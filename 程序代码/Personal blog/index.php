			...
			<nav class="navbar navbar-default" id="navbar">
				<div class="container">
					...
					<div class="navbar-header">
						...
						<h1 class="logo hvr-bounce-in"><a href="#" title="在线新闻网"><img src="" alt="在线新闻网"></a></h1>
					</div>
					<div class="collapse navbar-collapse" id="header-navbar">
						...
						<ul class="nav navbar-nav navbar-right">
							<li><a data-cont="在线新闻网" title="在线新闻网" href="index.php">首页</a></li>
							<li><a data-cont="在线新闻网" title="在线新闻网" href="index.php?newstype=娱乐新闻">娱乐新闻</a></li>
							<li><a data-cont="在线新闻网" title="在线新闻网" href="index.php?newstype=科技新闻">科技新闻</a></li>
							<li><a data-cont="在线新闻网" title="在线新闻网" href="index.php?newstype=体育新闻">体育新闻</a></li>
							<li><a data-cont="在线新闻网" title="在线新闻网" href="index.php?newstype=外国新闻">外国新闻</a></li>
						</ul>
					</div>
				</div>
			</nav>
					...
					<div id="focusslide" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner" role="listbox">
							<div class="item active">
								<a href="#" target="_blank" title="在线新闻网" >
								<img src="images//advertising1.jpg" alt="在线新闻网" class="img-responsive"></a>
							</div>
							<div class="item">
								<a href="#" target="_blank" title="在线新闻网" >
								<img src="images//advertising2.jpg" alt="在线新闻网" class="img-responsive"></a>
							</div>
							<div class="item">
								<a href="#" target="_blank" title="在线新闻网" >
								<img src="images//advertising3.jpg" alt="在线新闻网" class="img-responsive"></a>
							</div>
						</div>
