...
<div align="center" style="height:1500px ;background-color: "> <!-- 总画布 -->
	...
	<div id="search" class="search">
		...
		<form action="index_search.php" method="GET">
			<input type="text" placeholder="请输入要查找的新闻信息" value=""  name="newsearch" required="required">
	...
	<div id="right1" style="background-color: ; display: ;width:800px;height:800px;margin-top:-1120px;margin-left:300px"> <!-- 右边新闻显示区域 -->
	<h1   style="font-size:2.2em; color:white; margin-top:50px" >最新新闻 </h1>
	 <div align="left" style="margin-top:-20px;"class="right" >
	 <br><br>
	 <?php 
		error_reporting(E_ALL ^ E_NOTICE&&E_ALL ^ E_WARNING);
		$sqlcmd3="select *from news order by time desc limit  15";
		$result3=mysql_query($sqlcmd3);
	 		while($record3=mysql_fetch_array($result3))
			 {	 
			 	$titleb=mb_substr($record3[title],0,15);
			 	$s12=$record3['id'];
			 	echo"<a href='newsin.php?id=$s12' >$titleb</a>";
			 	echo"<br><br>";
			 }
			 ?>
...
<span style="font-family:arial; color:white;font-size:22px;position:absolute;bottom:-450px;right:100px">Copyright &copy;2017 NewsPublishingSystem by sy</span>	  
